...
def run_sync(
    ...
    *,
    ...
    cmd = build_command(prompt, session_id=session_id, model=model, effort=effort, streaming=False, system_prompt=system_prompt, create_session=create_session)
...
def stream_sync(
    ...
    *,
    ...
    cmd = build_command(prompt, session_id=session_id, model=model, effort=effort, streaming=True, system_prompt=system_prompt, create_session=create_session)
