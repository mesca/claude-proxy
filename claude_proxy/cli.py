...
def run_sync(
    ...
    *,
    ...
    cmd = build_command(prompt, model=model, effort=effort, streaming=False, system_prompt=system_prompt)
...
def stream_sync(
    ...
    *,
    ...
    cmd = build_command(prompt, model=model, effort=effort, streaming=True, system_prompt=system_prompt)
